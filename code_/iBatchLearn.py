...
def main():
    ...
    # parser.add_argument('--cfg', default='init_models/10splitTasks.yaml',type=str, required=False)
    # parser.add_argument('--user_cfg',default='utils/user_10splitTasks.yaml', type=str, required=False)
    # parser.add_argument('--test', default=False, action='store_true')
    # parser.add_argument('--task_count', default=0, type=int)
    # parser.add_argument('--init_path', default='init_models/10splitTasks.pth', type=str)
    # parser.add_argument('--ckpt_path', default='model_info/10splitTasks/checkpoint-0.pth', type=str)
    # # parser.add_argument('--ckpt_path', default='init_models/10splitTasks.pth', type=str)
    #
    # parser.add_argument('--save_ckpt_path', default='model_info/10splitTasks/checkpoint-0.pth', type=str)
    # parser.add_argument('--storage_path', default=None, type=str)
    # parser.add_argument('--save_storage_path', default='model_info/10splitTasks/storage-0.pth', type=str)
    # parser.add_argument('--dest_path', default=None, type=str)
    # parser.add_argument('--suffix', default=4, type=str)
